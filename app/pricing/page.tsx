...
const comparisonFeatures = [
  ...
  { name: "Image resolution", lite: "2048px", pro: "4K", ultra: "4K" },
  { name: "Max video duration", lite: "10s", pro: "15s", ultra: "60s" },
  { name: "Concurrent jobs", lite: "2", pro: "3", ultra: "6" },
  { name: "No watermark", lite: false, pro: true, ultra: true },
  { name: "Commercial license", lite: true, pro: true, ultra: true },
  { name: "Priority speed", lite: false, pro: true, ultra: true },
  { name: "Privacy controls", lite: false, pro: true, ultra: true },
  { name: "Copy protection", lite: false, pro: true, ultra: true },
  { name: "Unlimited models", lite: false, pro: false, ultra: true },
  { name: "Support", lite: "Standard", pro: "Priority", ultra: "Priority" },
];
