...
const sidebarTools: SidebarItem[] = [
  { icon: Home, label: "Home", href: "/", active: false },
  {
    ...
    items: [
      ...
      { icon: Video, label: "Text to Video", href: "/generate", active: false, badge: null },
...
const discoverLinks = [
  { label: "Text to Video", href: "/generate" },
  { label: "Video to Video", href: "#" },
  { label: "Text to Image", href: "/generate" },
        ...
        <main className="flex-1 overflow-y-auto px-6 py-6">
          <div className="max-w-[640px] mx-auto flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-3 pt-2">
              ...
              <Button
                className="w-full h-[52px] rounded-2xl bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] hover:from-[#5558E0] hover:to-[#7C4FE0] text-white font-semibold text-[15px] transition-all"
              >
