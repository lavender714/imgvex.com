...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "We offer a 3-day money-back guarantee for first-time subscribers. If you are not satisfied with the Service, you may request a full refund within 3 days of your initial purchase, provided you have used fewer than 50 credits. Refund requests must be submitted via email to support@imgvex.com.",
