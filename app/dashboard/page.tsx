    ...
    <div className="min-h-screen bg-[#0B0817] flex flex-col">
      ...
      <header className="h-[60px] border-b border-[#1E293B] bg-[#06060A] flex items-center justify-between px-6 shrink-0">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="w-9 h-9 rounded-full bg-[#6366F1] flex items-center justify-center text-sm font-semibold text-white">
            JD
          </div>
        </div>
      </header>
        ...
        <main className="flex-1 overflow-y-auto p-8">
          <div className="flex flex-col gap-8 max-w-[1200px]">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-semibold text-[#F8FAFC]">Good morning, John</h1>
