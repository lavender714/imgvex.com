...
const dropdownMenus: DropdownSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Video, label: "Text to Video", href: "/generate", desc: "Prompt-to-video generation" },
  ...
  },
  {
    label: "Image AI",
    items: [
      { icon: Type, label: "Text to Image", href: "/generate", desc: "Prompt-to-image creation" },
    ...
    <header className="fixed top-0 left-0 right-0 z-50 h-[72px] bg-[#06060A]/85 backdrop-blur-md border-b border-[#1E293B]/50">
      <div className="max-w-[1400px] mx-auto h-full flex items-center justify-between px-6 lg:px-12">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            className="rounded-full bg-[#F8FAFC] hover:bg-[#E2E8F0] text-[#0B0817] font-semibold px-5 py-2 text-sm"
            asChild
          >
